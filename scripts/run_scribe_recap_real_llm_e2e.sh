...
BACKEND_PORT="${MYROLL_E2E_BACKEND_PORT:-18180}"
FRONTEND_HOST="${MYROLL_E2E_FRONTEND_HOST:-127.0.0.1}"
FRONTEND_PORT="${MYROLL_E2E_FRONTEND_PORT:-15173}"
BACKEND_URL="http://$BACKEND_HOST:$BACKEND_PORT"
FRONTEND_URL="http://$FRONTEND_HOST:$FRONTEND_PORT"

RUN_ROOT="${MYROLL_E2E_RUN_ROOT:-$PROJECT_ROOT/artifacts/e2e/scribe-recap-real}"
...
MYROLL_E2E_LLM_MODEL="$LLM_MODEL" \
  npm --prefix "$PROJECT_ROOT/frontend" run test:e2e -- scribe-recap-real.spec.ts
