...
const summary = {
  ...
  recapVerifierEnabled: reports.find((report) => typeof report.recapVerifierEnabled === "boolean")?.recapVerifierEnabled ?? null,
  categories: {},
  scenarios: [],
  checks: {},
};
...
const lines = [
  ...
  `Recap verifier: ${summary.recapVerifierEnabled === null ? "mixed/unknown" : summary.recapVerifierEnabled ? "enabled" : "disabled"}`,
  "",
  "## Categories",
